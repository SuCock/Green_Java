INSERT INTO user (NAME, nickname, phone_num, email, studies, PASSWORD, enrollment_status, grade, withdraw_status, create_date)
VALUES('김길동','aaa','01000000000','aaa@naver.com','약학과','12341234','N',null,'Y','2015/02/15');

INSERT INTO user (NAME, nickname, phone_num, email, studies, PASSWORD, enrollment_status, grade, withdraw_status, create_date)
VALUES('감길동','aab','01011111111','aab@naver.com','경영학과','111111','Y','third','N','2020/02/18');

INSERT INTO user (NAME, nickname, phone_num, email, studies, PASSWORD, enrollment_status, grade, withdraw_status, create_date)
VALUES('Steve','steve','01011112222','steve1234@google.com','영어영문학과','111122','Y','second','N','2022/02/18');

INSERT INTO user (NAME, nickname, phone_num, email, studies, PASSWORD, enrollment_status, grade, withdraw_status, create_date)
VALUES('Karen','karen','01035642522','karen0000@google.com','국어국문학과','356425','Y','fourth','N','2019/02/20');

INSERT INTO user (NAME, nickname, phone_num, email, studies, PASSWORD, enrollment_status, grade, withdraw_status, create_date)
VALUES('김철수','chulsoo','01025662122','chulsoo0001@google.com','교육학과','212266','Y','first','N','2023/02/18');

INSERT INTO user (NAME, nickname, phone_num, email, studies, PASSWORD, enrollment_status, grade, withdraw_status, create_date)
VALUES('손길동','손길동','01015312564','손길동1234@naver.com','피아노전공','15312564','Y','third','Y','2019/02/18');

INSERT INTO user (NAME, nickname, phone_num, email, studies, PASSWORD, enrollment_status, grade, withdraw_status, create_date)
VALUES('황유나','yuna','01013412422','yuna1341@google.com','심리학과','134124','Y','first','N','2022/02/18');

INSERT INTO user (NAME, nickname, phone_num, email, studies, PASSWORD, enrollment_status, grade, withdraw_status, create_date)
VALUES('권길동','권길동','01059182562','GGD1234@google.com','경찰행정학','591825','Y','fourth','Y','2018/02/18');

INSERT INTO user (NAME, nickname, phone_num, email, studies, PASSWORD, enrollment_status, grade, withdraw_status, create_date)
VALUES('David','machine','01018592652','machine2256@google.com','기계공학','185926','N',null,'Y','2017/03/08');

INSERT INTO user (NAME, nickname, phone_num, email, studies, PASSWORD, enrollment_status, grade, withdraw_status, create_date)
VALUES('Cindy','cd','01018592655','m2256@google.com','유아교육학과','185956','N',null,'Y','2016/03/08');
...
--Insert into board (create_date, modified_date,content,title,categories) values ('')
